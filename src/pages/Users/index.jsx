    ...
    return (
        <div className="users-container">
            ...
            <div className="user-container">
                <Link to="/app" state={{ avatar: avatar1 }}>
                    <div className="avatar-container">
                        <img src={avatar1} alt="avatar" />
                        <p>Pessoa 1</p>
                    </div>
                </Link>
                <Link to="/app" state={{ avatar: avatar2 }}>
                    <div className="avatar-container">
                        <img src={avatar2} alt="avatar" />
                        <p>Pessoa 2</p>
                    </div>
                </Link>
                <Link to="/app" state={{ avatar: avatar3 }}>
                    <div className="avatar-container">
                        <img src={avatar3} alt="avatar" />
                        <p>Pessoa 3</p>
                    </div>
                </Link>
                <Link to="/app" state={{ avatar: avatar4 }}>
                    <div className="avatar-container">
                        <img src={avatar4} alt="avatar" />
                        <p>Pessoa 4</p>
                    </div>
                </Link>
                <Link to="/app" state={{ avatar: avatar5 }}>
                    <div className="avatar-container">
